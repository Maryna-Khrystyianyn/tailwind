      ...
      <div className="round bg-red-100 m-3 rounded-2xl p-5 ">
        ...
        <form action="">
          <div className="grid lg:grid-cols-[1fr_2fr] lg:gap-20">
            <div className="md:w-130 lg:w-70">
            ...
            <div>
              {" "}
              <div className=" flex flex-col mt-6 lg:flex-row lg:justify-between lg:mt-12">
              ...
              <div className=" flex flex-col mt-6 lg:flex-row lg:justify-between">
                ...
                <input type="text" id="EmailId" className="bg-white lg:w-70" />
              </div>
            </div>
          </div>
          {/* ================== */}

          <div className="grid grid-cols-2 gap-x-15 gap-y-5 mt-6 lg:grid-cols-4 lg:grid-reverse">
          ...
          <div className="mt-15 lg:flex lg:justify-center lg:items-center">
            <div className=" lg:flex lg:w-100 lg:items-center lg:justify-center">
              <input
                type="checkbox"
                className=" appearance-none w-3 h-3 border border-2 border-black bg-transparent checked:bg-blue-500 mr-3"
              />
